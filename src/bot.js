        ...
        if (response === 'sudah') {
            // await msg.reply("Terima Kasih! Data anda sedang dalam proses verifikasi. Anda akan dihubungi oleh petugas kami untuk langkah selanjutnya.");
                ...
                try {
                    ...
                    await msg.reply(" Terima kasih! Data anda sedang dalam proses verifikasi. Anda akan dihubungi kembali untuk proses selanjutnya.");
                } catch (err) {
        ...
        if (input === 'cancel') {
            ...
            switch(choice) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    message = "Mohon Sebutkan Seluruh no registrasi nasional contohnya *3173051-5134* atau *PXXXXXXXXXX-XXXX* ";
                    state.step = 3; 
                    break;
                case 4:
